    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-12 overflow-hidden">
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <div className={`space-y-6 mb-12 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'}`}>
          ...
          {/* CTA Buttons */}
          <div className={`flex flex-col gap-4 justify-center items-center pt-4 transition-all duration-1000 delay-300 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <a 
              href="https://flowlog-gg.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="border-2 border-seafoam/40 shadow-[0_0_25px_rgba(6,255,165,0.3)] hover:shadow-[0_0_40px_rgba(6,255,165,0.5)] hover:scale-105 transition-all duration-300 px-8 py-4 text-lg rounded-full inline-flex items-center justify-center"
            >
              <span className="font-bold bg-gradient-to-r from-rose-400 via-fuchsia-500 via-violet-500 via-cyan-400 to-emerald-400 bg-clip-text text-transparent">
                🚀 Try the MVP Now
              </span>
            </a>
            <Button 
